...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    readingTime: Schema.Attribute.Integer & Schema.Attribute.Private;
...
export interface ApiClientSiteClientSite extends Struct.CollectionTypeSchema {
  collectionName: 'client_sites';
  info: {
    displayName: 'Client Site';
    pluralName: 'client-sites';
    singularName: 'client-site';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTemplateTemplate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    numberForTemplatePosition: Schema.Attribute.Integer &
      Schema.Attribute.Unique;
